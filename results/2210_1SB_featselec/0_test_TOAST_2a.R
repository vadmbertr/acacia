...
score_perf_sup = lapply(deconv_methods_sup, function(meth) {
      if (file.exists(paste0("0_test_TOAST/deconv/deconv_",block,"_sup_",
                             meth,".rds"))) {
        A_pred=readRDS(paste0("0_test_TOAST/deconv/deconv_",block,"_sup_",
                              meth,".rds"))$res
...
score_perf_sup_bl = lapply(deconv_methods_sup, function(meth) {
  if (file.exists(paste0("0_test_TOAST/deconv/deconvbl_",block,"_sup_",
                         meth,".rds"))) {
    A_pred=readRDS(paste0("0_test_TOAST/deconv/deconvbl_",block,"_sup_",
                          meth,".rds"))$res
    if (all(is.na(A_pred))) {return(list("perf_g"=rep(NA,length(score_methods)),
                                         "perf_c"=matrix(NA, ncol=length(score_methods), nrow=nrow(Atrue)),
                                         "sd_c"=rep(NA,length(score_methods)),
...
score_perf_sup_bl2 = lapply(deconv_methods_sup, function(meth) {
  if (file.exists(paste0("0_test_TOAST/deconv/deconvbl2_",block,"_sup_",
                         meth,".rds"))) {
    A_pred=readRDS(paste0("0_test_TOAST/deconv/deconvbl2_",block,"_sup_",
                          meth,".rds"))$res
    if (all(is.na(A_pred))) {return(list("perf_g"=rep(NA,length(score_methods)),
                                         "perf_c"=matrix(NA, ncol=length(score_methods), nrow=nrow(Atrue)),
                                         "sd_c"=rep(NA,length(score_methods)),
...
score_perf_unsup = lapply(deconv_methods_unsup, function(meth) {
      if (file.exists(paste0("0_test_TOAST/deconv/deconv_",block,"_unsup_",
                             meth,".rds"))) {
        A_pred=readRDS(paste0("0_test_TOAST/deconv/deconv_",block,"_unsup_",
                              meth,".rds"))$res
        if (all(is.na(A_pred))) {return(list("perf_g"=rep(NA,length(score_methods)),
                                             "perf_c"=matrix(NA, ncol=length(score_methods), nrow=nrow(Atrue)),
                                             "sd_c"=rep(NA,length(score_methods)),
