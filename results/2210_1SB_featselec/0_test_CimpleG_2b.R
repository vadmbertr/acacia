...
tmp=lapply(deconv_methods_unsup, function(meth) {
      if (file.exists(paste0("0_test_CimpleG/deconv/deconvbl2_",block,"_unsup_",
                             meth,".rds"))) {
        res=readRDS(paste0("0_test_CimpleG/deconv/deconvbl2_",block,"_unsup_",
                           meth,".rds"))
        ...
        if (is.list(time)) {
          ...
          saveRDS(res, paste0("0_test_CimpleG/deconv/deconvbl2_",block,"_unsup_",
                               meth,".rds"))
        }
      }
  })
...
score_perf_sup = sapply(deconv_methods_sup, function(meth) {
      if (file.exists(paste0("0_test_CimpleG/deconv/deconv_",block,"_sup_",
                             meth,".rds"))) {
        readRDS(paste0("0_test_CimpleG/deconv/deconv_",block,"_sup_",
...
score_perf_sup_bl = sapply(deconv_methods_sup, function(meth) {
  if (file.exists(paste0("0_test_CimpleG/deconv/deconvbl_",block,"_sup_",
                         meth,".rds"))) {
    readRDS(paste0("0_test_CimpleG/deconv/deconvbl_",block,"_sup_",
                          meth,".rds"))$time_elapsed
  }
  else {print(paste0(meth," not run yet"))}
})
...
score_perf_sup_bl2 = sapply(deconv_methods_sup, function(meth) {
  if (file.exists(paste0("0_test_CimpleG/deconv/deconvbl2_",block,"_sup_",
                         meth,".rds"))) {
    readRDS(paste0("0_test_CimpleG/deconv/deconvbl2_",block,"_sup_",
                   meth,".rds"))$time_elapsed
  }
  else {print(paste0(meth," not run yet"))}
})
...
score_perf_unsup = sapply(deconv_methods_unsup, function(meth) {
      if (file.exists(paste0("0_test_CimpleG/deconv/deconv_",block,"_unsup_",
                             meth,".rds"))) {
        readRDS(paste0("0_test_CimpleG/deconv/deconv_",block,"_unsup_",
                              meth,".rds"))$time_elapsed
      }
      else {print(paste0(meth," not run yet"))}
  })
