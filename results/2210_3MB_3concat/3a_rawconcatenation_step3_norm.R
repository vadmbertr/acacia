...
score_rawconcat <- readRDS("3a_rawconcatenation_step2_norm/perf_scores/221101_scores.rds")
...
time_rawconcat=lapply(seq(n_lot), function(lot) {
  lapply(seq(n_sims), function(sim) {
    ...
    sapply(deconv_methods, function(meth) {
      if (file.exists(paste0("3a_rawconcatenation_step2_norm/deconv/221101_",name_data[lot],
                               "_Apred_",
                               meth,
                               "_",sim_txt,sim,".rds"))) {
          tmp=readRDS(paste0("3a_rawconcatenation_step2_norm/deconv/221101_",name_data[lot],
                             "_Apred_",
                             meth,
                             "_",sim_txt,sim,".rds"))$time_elapsed
          tmp0=readRDS(paste0("3a_rawconcatenation_step2_norm/deconv/221101_",name_data[lot],
                              "_Apred_",
                              meth,
          ...
          if (is.list(tmp)) {
            ...
            saveRDS(list(res=tmp0,time_elapsed=tmp),paste0("3a_rawconcatenation_step2_norm/deconv/221101_",name_data[lot],
                                                           "_Apred_",
                                                           meth,
                                                           "_",sim_txt,sim,".rds"))
          }
...
ggsave(paste0("3a_rawconcatenation_step3_norm/221101_plot_",rank_type,"_",rank_norm,".pdf"),
       width=8, height=4)
